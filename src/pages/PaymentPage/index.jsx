          ...
          >
            ...
            >
              <Flex
                ...
                borderLeft={method === "Card" && `5px solid #0071dc`}
                padding="2"
                boxShadow="md"
                borderRadius="10px"
                width={{
              ...
              <Flex
                ...
                gap="1"
                border="1px solid grey"
                borderLeft={method === "Cod" && "5px solid #0071dc"}
                padding="2"
                boxShadow="md"
                borderRadius="10px"
              >
              ...
              <Flex
                ...
                gap="1"
                border="1px solid grey"
                borderLeft={method === "Gift" && "5px solid #0071dc"}
                padding="2"
                boxShadow="md"
                borderRadius="10px"
              >
              ...
              <Flex
                ...
                gap="1"
                border="1px solid grey"
                borderLeft={method === "Paytm" && "5px solid #0071dc"}
                padding="2"
                boxShadow="md"
                borderRadius="10px"
              >
